                                                ...
                                                <c:if test="${!empty list3}">
                                                    <c:forEach var="i" begin="0" end="${list3.size()-1}">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>${list3.get(i).getHotelModel().getId()}</td>
                                                                <td>${list3.get(i).getCustomerModel().getId()}</td>
                                                                <td>${list3.get(i).getRoomModel().getRoomNo()}</td>
                                                                <td>${list3.get(i).getBookingTime()}</td>
                                                                <td>${list3.get(i).getArrivalTime()}</td>
                                                                <td>${list3.get(i).getDepartureTime()}</td>
                                                                <td>${list3.get(i).getNumAdults()}</td>
                                                                <td>${list3.get(i).getNumChilds()}</td>
                                                                <td>${list3.get(i).getSpecialReq()}</td>
                                                                <td>Declined</td>
                                                            </tr>
                                                    </c:forEach>
                                                </c:if>
