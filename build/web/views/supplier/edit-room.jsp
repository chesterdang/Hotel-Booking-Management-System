<%-- 
    Document   : edit-room
    Created on : 7 Mar 2024, 3:23:25 pm
    Author     : MaiGiang
--%>
                                ...
                                <div class="row formtype">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="roomType" name="roomType" required>
                                                <option value="1" ${room.roomTypeModel.roomType == 'Single' ? 'selected' : ''}>Single</option>
                                                <option value="2" ${room.roomTypeModel.roomType == 'Double' ? 'selected' : ''}>Double</option>
                                                <option value="3" ${room.roomTypeModel.roomType == 'Suite' ? 'selected' : ''}>Suite</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control"  id="roomPrice" name="roomPrice" value="${room.money}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" disabled id="roomTypeDesc" name="roomTypeDesc" value="${room.roomTypeModel.roomDesc}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" id="occupancy" name="occupancy" min="0" max="9" value="${room.occupancy}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="priceIncludes" name="priceIncludes" value="${room.priceIncludes}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input placeholder="file-size <= 10mb" type="file" name="avatar" accept=".jpg, .png"  class="form-control"> 
                                        </div>
                                    </div>
