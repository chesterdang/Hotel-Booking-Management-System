                                ...
                                <div class="card-body booking_card">
                                    <div class="table-responsive">
                                        <table class="datatable table table-stripped table table-hover table-center mb-0">
                                            ...
                                            <tbody>
                                                <c:if test="${!empty listCC2}">
                                                    <c:forEach var="i" begin="0" end="${listCC2.size()-1}">
                                                    
                                                            <tr>
                                                                
                                                                <td>${listCC2.get(i).customerId}</td>
                                                                <td>${listCC2.get(i).bookingTime}</td>
                                                                <td>${listCC2.get(i).count}</td>
                                                                <td>Accepted</td>
                                                            </tr>
                                                    </c:forEach>
                                                </c:if>
