                                                    ...
                                                    <c:forEach var="i" begin="0" end="${list.size()-1}">
                                                            ...
                                                            <tr>
                                                                <td class="text-center">
                                                                    ...
                                                                    <c:if test="${list.get(i).getStatus() == 0}"> 
                                                                        <div class="btn-group d-flex justify-content-center"> 

                                                                            <a href="confirmBookingServlet?id=${i}&action=1&bookingId=${list.get(i).getId()}" class="btn btn-success btn-sm confirm-btn">Confirm </a>
                                                                            <a href="confirmBookingServlet?id=${i}&action=2&bookingId=${list.get(i).getId()}" class="btn btn-danger btn-sm cancel-btn">Cancel </a>
                                                                        </div>
                                                                    </c:if>
                                                                </td>
                                                                <td>${list.get(i).getId()}</td>
                                                                <td>${list.get(i).getHotelModel().getId()}</td>
                                                                <td>${list.get(i).getCustomerModel().getId()}</td>
                                                                <td>${list.get(i).getRoomModel().getRoomNo()}</td>
                                                                <td>${list.get(i).getBookingTime()}</td>
                                                                <td>${list.get(i).getArrivalTime()}</td>
                                                                <td>${list.get(i).getDepartureTime()}</td>
                                                                <td>${list.get(i).getNumAdults()}</td>
                                                                <td>${list.get(i).getNumChilds()}</td>
                                                                <td>${list.get(i).getSpecialReq()}</td>
                                                                <td>Pending</td>
                                                            </tr>
                                                    </c:forEach>
                                                </c:if>
