                                ...
                                <div class="card-body booking_card">
                                    <div class="table-responsive">
                                        <table class="datatable table table-stripped table table-hover table-center mb-0">
                                            ...
                                            <tbody>
                                                <c:if test="${!empty listCC3}">
                                                    <c:forEach var="i" begin="0" end="${listCC3.size()-1}">
                                                            <tr>
                                                                <td>${listCC3.get(i).customerId}</td>
                                                                <td>${listCC3.get(i).bookingTime}</td>
                                                                <td>${listCC3.get(i).count}</td>
                                                                <td>Declined</td>
                                                            </tr>
                                                    </c:forEach>
                                                </c:if>
