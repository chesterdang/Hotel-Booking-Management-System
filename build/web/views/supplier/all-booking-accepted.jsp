                                                ...
                                                <c:if test="${!empty list2}">
                                                    <c:forEach var="i" begin="0" end="${list2.size()-1}">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>${list2.get(i).getHotelModel().getId()}</td>
                                                                <td>${list2.get(i).getCustomerModel().getId()}</td>
                                                                <td>${list2.get(i).getRoomModel().getRoomNo()}</td>
                                                                <td>${list2.get(i).getBookingTime()}</td>
                                                                <td>${list2.get(i).getArrivalTime()}</td>
                                                                <td>${list2.get(i).getDepartureTime()}</td>
                                                                <td>${list2.get(i).getNumAdults()}</td>
                                                                <td>${list2.get(i).getNumChilds()}</td>
                                                                <td>${list2.get(i).getSpecialReq()}</td>
                                                                <td>Accepted</td>
                                                            </tr>
                                                    </c:forEach>
                                                </c:if>
