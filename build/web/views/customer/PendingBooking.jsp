...
<body id="bodyTag"> 
	<div class="main-wrapper">
		...
		<div class="page-wrapper">
                         <!--<!-- Alert -->
                        <c:if test= "${not empty alert} style='margin-top: 50px' ">
			...
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
								<h4 class="card-title float-left mt-2">${title}</h4>
                                </div>
					</div>
					</div>
				</div>
								...
								<div class="table-responsive">
									<table class="datatable table table-stripped table table-hover table-center mb-0">
										...
										<tbody>
												...
												<td>${booking.id}</td>
												<td>
											           ${booking.hotelModel.name}
                                                                                                </td>
												<td>${booking.roomModel.roomTypeModel.roomType}</td>
												<td>${booking.numAdults + book.numChilds}</td>
												...
												<td>${booking.specialReq}</td>
													...
													<div class="dropdown dropdown-action"> <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v ellipse_color"></i></a>
														<div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_asset"><i class="fas fa-trash-alt m-r-5"></i>Cancel Booking</a> </div>
													</div>
                                                                                                    </td>
                                                                                                </c:if>
											</tr>
   ...
   <script>   
    ...
    if("${title}" == "Already"){
         url = "/BookingHotel_Prj301/BookingController?action=alreadyBooking&fetch=6&page=";  
    }else{
        url = "/BookingHotel_Prj301/BookingController?action=pendingBooking&fetch=6&page=";  
    }
