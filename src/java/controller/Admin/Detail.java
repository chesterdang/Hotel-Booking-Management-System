...
public class Detail extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (role) {
            case "Customer":
                    cust = customerService.findBy(Long.parseLong(id));
                break;             
                case "Supplier":                    
                   cust = supplierService.findBy(Long.parseLong(id));          
                break;
            default:
                throw new AssertionError();
        }
        request.setAttribute("cust", cust);
        request.getRequestDispatcher("views/Admin/Include/detail.jsp").forward(request, response);
    }
