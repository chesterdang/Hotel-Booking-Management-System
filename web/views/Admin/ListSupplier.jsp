<%-- 
    ...
    Created on : Mar 6, 2024, 1:31:25 AM
    Author     : quandba
--%>
...
<html>
    <head>
        <link href="assets/AdminSpace/css_include/supplier.css" rel="stylesheet"/>
                    ...
                    <div class="content container-fluid">
                        <div class="page-header xuong">
                            ...
                            <div class="row align-items-center">
                                <div class="col">
                                    <h4 class="card-title float-left mt-2">Supplier</h4> 
                                                ...
                                                <div class="numberP vuong" id="number${i}" style="width: 30px; border: black groove 2px; background-color: white; ">  
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${not empty searchInput}">
                                                            <a id="link${i}" style="text-decoration: none;"  href="list_supplier?index=${i}&action=${sortType}&search=${searchValue}">${i}</a>   
                                                        </c:when>

                                                        <c:otherwise>
                                                            <a id="link${i}" style="text-decoration: none;"  href="list_supplier?index=${i}&action=${sortType}">${i}</a>   
                                                        </c:otherwise>
                                                    </c:choose>
                                                </div>
                                            </c:forEach>    
        ...
        <script>
            ...
            function search() {
                ...
                if (searchValue == "") {
                    ...
                    window.location.href = 'list_supplier?action=numASC&search=' + searchValue + "&index=" + indexValue + "";
                    console.log('list_supplier?action=numASC&search=' + searchValue + "&index=" + indexValue + "");
                }
            ...
            document.getElementById('sortType').onchange = function () {
                ...
                if (searchValue != null) {
                    window.location.href = 'list_supplier?action=' + selectedOption + '&search=' + searchValue;
                } else {
                    window.location.href = 'list_supplier?action=' + selectedOption;
                }
            }
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                checkboxes.forEach(function (checkbox) {
                    checkbox.addEventListener('change', function () {
                        ...
                        if (searchValue == "") {
                            if (this.checked) {
                                window.location.href = 'list_supplier?unlock=1&id=' + id + '&action=numASC&index=' + indexValue + '';
                            } else {
                                window.location.href = 'list_supplier?delete=1&id=' + id + '&action=numASC&index=' + indexValue + '';
                            }
                        } else {
                            if (this.checked) {
                                window.location.href = 'list_supplier?unlock=1&id=' + id + '&action=numASC&index=' + indexValue + '&search=' + searchValue + '';
                            } else {
                                window.location.href = 'list_supplier?delete=1&id=' + id + '&action=numASC&index=' + indexValue + '&search=' + searchValue + '';
                            }
                        }
