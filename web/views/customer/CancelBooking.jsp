...
<head>
	...
	<title>Cancel Booking Home</title>
...
<body id="bodyTag"> 
			...
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
								<h4 class="card-title float-left mt-2">Cancel Booking</h4>
                                </div>
					</div>
					</div>
				</div>
								...
								<div class="table-responsive">
									<table class="datatable table table-stripped table table-hover table-center mb-0">
										...
										<tbody>
												...
												<td>${booking.id}</td>
												<td>
											           ${booking.bookingModel.hotelModel.name}
                                                                                                </td>
												<td>${booking.bookingModel.roomModel.roomTypeModel.roomType}</td>
												<td>${booking.bookingModel.bookingTime}</td>
   ...
   <script>   
    ...
    if(${not empty pagingUrl}){
        ...
        url = "/BookingHotel_Prj301/BookingController?action=cancelBooking&fetch=6&page=";  
    }
