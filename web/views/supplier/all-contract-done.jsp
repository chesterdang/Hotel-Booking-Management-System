                                ...
                                <div class="card-body booking_card">
                                    <div class="table-responsive">
                                        <table class="datatable table table-stripped table table-hover table-center mb-0">
                                            ...
                                            <tbody>
                                                <c:if test="${!empty listCC4}">
                                                    <c:forEach var="i" begin="0" end="${listCC4.size()-1}">
                                                    
                                                            <tr>
                                                                
                                                                <td>${listCC4.get(i).customerId}</td>
                                                                <td>${listCC4.get(i).bookingTime}</td>
                                                                <td>${listCC4.get(i).count}</td>
                                                                <td>Done</td>
                                                            </tr>
                                                    </c:forEach>
                                                </c:if>
