                ...
                <div class="content container-fluid">
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <div class="mt-5">
                                    <h4 class="card-title float-left mt-2">Contract Management</h4>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card card-table">
                                ...
                                <c:if test="${checkEmpty eq 0}">
                                        <div class=" w3-container">
                                        <table class="w3-center w3-animate-right table   table-center mb-0">
                                            <thead>
                                                    <tr>
                                                        <th>CustomerID</th>
                                                        <th>Booking Time</th>
                                                        <th>Number Of Rooms</th>
                                                        <c:forEach var="roomtype" items="${map.keySet()}">
                                                            <td>${roomtype}</td>
                                                        </c:forEach>
                                                    </tr>                                               
                                            </thead>
                                            <tbody>
                                                    <tr>
                                                        ...
                                                        <td>${contract.bookingTime}</td>
                                                        <td>${contract.count}</td>
                                                        <c:forEach var="roomtype" items="${map.keySet()}">
                                                            <td>${map.get(roomtype)}</td>
                                                        </c:forEach>
                                                    </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <center>
                                        <div>
                                            <form>
                                                <a href="confirmPendingContract?action=5" class="btn btn-success btn-sm confirm-btn">Confirm </a>
                                                <a href="confirmPendingContract?action=6" class="btn btn-danger btn-sm cancel-btn">Cancel </a>
                                            </form>
                                        </div>
                                    </center>
                                ...
                                <c:if test="${checkEmpty eq 1}">
                                    <h2>No Pending Contract</h2>
                                </c:if>
                            </div>
                        </div>
                    </div>
