	...
	<div class="main-wrapper">
            <div class="header">
                <div class="header-left">
                    <a href="${pageContext.request.contextPath}/views/supplier/home.jsp" class="logo"> <img src="${pageContext.request.contextPath}/assets/supplier/js/hotel_logo.png" width="50" height="70" alt="logo"> <span class="logoclass">HOTEL</span> </a>
                    ...
                    <li class="nav-item dropdown has-arrow">
                        ...
                        <div class="dropdown-menu">
                            <div class="user-header">
                                ...
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/supplierProfileServlet?action=showUpdateProfile&supplierId=${supplierId}">My Profile</a> 
                ...
                <div class="sidebar-inner slimscroll">
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            ...
                            <c:set var="supplierId" value="${user.id}" scope="session"/>    
                            ...
                            <li > <a href="${pageContext.request.contextPath}/displayCustomerServlet"><i class="fas fa-user"></i> <span> Customers </span></a></li>
                            <li class="submenu"> <a href="#"><i class="fas fa-key"></i> <span> Rooms </span> <span class="menu-arrow"></span></a>
                                <ul class="submenu_class" >
                                    <li><a href="${pageContext.request.contextPath}/roomManagementServlet?action=listRoom">All Rooms </a></li>

                                    <li><a href="${pageContext.request.contextPath}/roomManagementServlet?action=showAdd&supplierId=${supplierId}"> Add Rooms </a></li>
                                </ul>
                            </li>
				...
				<div class="page-header">
					<div class="row">
						<div class="col-sm-12 mt-5">
							<h3 class="page-title mt-3"> Hello ${user.fullname}!</h3>
							<ul class="breadcrumb">
